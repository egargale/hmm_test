# ADR-0008: Excise Dead Weight Modules
...
- [[ADR-0009]] Engine seam deepening — easier after dead modules are gone
- [[ADR-0010]] Feature engineering trim — `FeatureEngineer` class removal is part of this ADR
- [[ADR-0004]] CLI data loading seam — independent of this ADR
