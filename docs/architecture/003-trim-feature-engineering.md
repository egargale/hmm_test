...
- [[ADR-001]] Excise dead weight — `FeatureEngineer` removal overlaps with this PR; `feature_selection.py` deletion belongs in ADR-001
- [[ADR-002]] Engine seam — generic feature module would sit behind `HmmGenericEngine.precompute()`
