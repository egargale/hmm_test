...
from data_processing.csv_parser import process_csv, _validate_ohlcv_data
...
class TestCsvParser:
    ...
    def test_validate_ohlcv_data_missing_columns(self):
        ...
        with pytest.raises(ValueError, match="Missing required OHLCV columns"):
            _validate_ohlcv_data(invalid_data)
...
class TestDataValidation:
    ...
    def test_validate_data_with_outliers(self):
        ...
        outlier_issues = [issue for issue in validation_result['issues_found']
...
class TestFeatureEngineering:
    ...
    def test_add_features_moving_averages(self, sample_ohlcv_data):
        ...
        features = add_features(sample_ohlcv_data, config=config)
    ...
    def test_add_features_volatility(self, sample_ohlcv_data):
        ...
        expected_columns = [
            'volatility_std_14', 'volatility_std_21',
            'atr_14', 'atr_21'
        ]
    ...
    def test_add_features_momentum(self, sample_ohlcv_data):
        ...
        momentum_columns = [col for col in features.columns if 'momentum_' in col]
    ...
    def test_add_features_volume(self, sample_ohlcv_data):
        ...
        volume_columns = [col for col in features.columns if 'volume_' in col]
    ...
    def test_add_features_custom(self, sample_ohlcv_data):
        ...
        assert 'daily_ratio' in features.columns
    ...
    def test_add_features_empty_config(self, sample_ohlcv_data):
        ...
        # Should still add basic returns
        assert 'returns' in features.columns
...
class TestDataProcessingIntegration:
    ...
    def test_config_driven_processing(self, sample_ohlcv_csv_file):
        ...
        features = add_features(clean_data, config=feature_config)
