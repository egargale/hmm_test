...
def _resolve_engine(
    ...
    if isinstance(engine, str):
        ...
        if engine == "fshmm":
            return cls(n_states=n_states, pca_variance=pca_variance, saliency_threshold=saliency_threshold)
...
def walk_forward_backtest(
    ...
    *,
    ...
    """
    eng = _resolve_engine(engine, window, threshold, n_states, ohlcv, pca_variance, saliency_threshold)
